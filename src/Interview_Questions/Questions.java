...
public class Questions {
    public static void main(String[] args) {
        ...
        ll2.insertNode(9);
        ll2.insertNode(2);
        LinkedList resLL = sumLists(ll1, ll2);
        resLL.traverseLL();
    }

    public static void removeDuplicates(LinkedList ll) { // O(n)
    ...
    public static Node nthElementFromEnd(LinkedList ll, int n) { // O(n)
        Node p1 = ll.head;
        Node p2 = ll.head;
        for (int i = 0; i < n; i++) {
            if (p2 == null) {
    ...
    public static LinkedList partition(LinkedList ll, int x) { // O(n)
